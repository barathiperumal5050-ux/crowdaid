...
switch (true) {
  case path.includes('otp'):       initOTPPage();    break;
  case path.includes('report'):    initReportPage(); break;
  case path.includes('room'):      initRoomPage();   break;
  case path.includes('dashboard'): initDashboard();  break;
}
